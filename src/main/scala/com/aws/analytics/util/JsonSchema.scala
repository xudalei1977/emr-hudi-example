...
object JsonSchema {
  ...
  def getCDCJsonSchemaFromJSONString(jsonString: String): StructType= {
    ...
    getCDCJsonSchemaFromJSONObject(jsonObj)
  }


  def getCDCJsonSchemaFromJSONObject(jsonObj: JSONObject): StructType= {
